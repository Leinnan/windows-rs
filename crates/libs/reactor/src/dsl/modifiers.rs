...
impl ElementExt for Element {
    ...
    fn with_key(mut self, key: impl Into<String>) -> Self {
        ...
        match &mut self {
            ...
            Element::ColorPickerWidget(v) => v.key = Some(key),
            Element::DatePickerWidget(v) => v.key = Some(key),
            Element::TimePickerWidget(v) => v.key = Some(key),
            Element::CalendarDatePickerWidget(v) => v.key = Some(key),
            Element::CalendarViewWidget(v) => v.key = Some(key),
            Element::ListBoxWidget(v) => v.key = Some(key),
            Element::DropDownButtonWidget(v) => v.key = Some(key),
            Element::SplitButtonWidget(v) => v.key = Some(key),
            Element::AutoSuggestBoxWidget(v) => v.key = Some(key),
            Element::SplitViewWidget(v) => v.key = Some(key),
            Element::MenuBarWidget(v) => v.key = Some(key),
            Element::ScrollViewWidget(v) => v.key = Some(key),
            Element::TreeViewWidget(v) => v.key = Some(key),
            Element::CommandBarWidget(v) => v.key = Some(key),
            Element::TeachingTipWidget(v) => v.key = Some(key),
            Element::SelectorBarWidget(v) => v.key = Some(key),
            Element::RichEditBoxWidget(v) => v.key = Some(key),
            Element::RelativePanelWidget(v) => v.key = Some(key),
            Element::ToggleButtonWidget(v) => v.key = Some(key),
